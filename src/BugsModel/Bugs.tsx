...
import InfoPersonaje from "../InfoPersonaje/InfoBugs";
...
const Model = () => {
  ...
  useEffect(() => {
   ...
   // Luz 1 abajo
const directionalLight = new THREE.DirectionalLight(0x0ffffff, 2);
directionalLight.position.set(0, -1, 5);
scene.add(directionalLight);

// Luz 2 izquierda
const directionalLight2 = new THREE.DirectionalLight(0x1044ff, 2.5);
directionalLight2.position.set(-4, 3, -1);
scene.add(directionalLight2);

// Luz 3 derecha
const directionalLight3 = new THREE.DirectionalLight(0xff23cc, 2);
directionalLight3.position.set(-3, 3, 1);
scene.add(directionalLight3);
    ...
    loader.load(
      "/Bugs.glb", // asegúrate de que la ruta sea correcta
      (gltf) => {
...
const animate = () => {
  ...
  for (let i = 0; i < particleCount; i++) {
    ...
    const scale = 0.1 + 0.05 * Math.sin(time * 2 + i);
