...
scene.fog = new THREE.Fog(0x0d0d2b, 10, 40);
    ...
    loader.load(
      ...
      (gltf) => {
        ...
        center.y += 7; // eleva la etiqueta para que aparezca encima
...
for (let i = 0; i < particleCount; i++) {
  ...
  posAttr.setX(i, posAttr.getX(i) + Math.cos(angle) * 0.06); // movimiento circular
...
>
  Bugs Bunny es el conejo más cool de los dibujos animados. Siempre con una zanahoria en la mano y una sonrisa pícara en la cara, este maestro del sarcasmo no se deja atrapar fácilmente. 
  <br /><br />
  Le encanta burlarse de sus enemigos con su frase legendaria: "¿Qué hay de nuevo, viejo?" y siempre encuentra la forma más ingeniosa (y divertida) de salirse con la suya. Ya sea enfrentando a Elmer Gruñón o al Pato Lucas Bugs siempre gana... ¡sin despeinarse ni una oreja!
</div>
